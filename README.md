...
1. 工作能力-針對化工工廠製程優化、設備預知保養等問題，提出並實做AI解決方案，建立假設、找出資料中的意義，並應用在特定情境中。搭配機器學習/深度學習模型建置，以解決預測、分類、分群等問題，最終將專案模型實際部屬至廠內系統，以利於線上模型運作達到預期效果並提升效益。
2. 技術能力-熟悉程式語言python、擅長資料分析，使用Machine Learning模型優化經驗，並搭配Deep Learning框架，擅於TensorFlow / Keras框架建立深度學習模型，並整合優化類神經網路模型。；擅於使用BI工具將模型預測成果進行資料視覺化Visualization / DashBoard報表呈現。
4. 溝通能力-擅長與現場人員、user、擁有Domain Knowledge專家等進行溝通協調，熱於學習、瞭解化工製程之domain knowhow，學習專業知識，並使用資料科學的工具用來幫助與解決化工領域問題，並能清楚地將分析上的發現，傳達給其他如化工、業務、業務等非資料科學相關部門的人員，呈現資料分析的見解，以瞭解數據能如何影響、提升他們的製程成果。
4. 好奇心與自學能力-雖然非相關本科出身，但更能夠融入並教導其他非資料科學相關人員，因此擔任LCY AI School Engineer Training 課程導師、教學Python與機器學習課程，使工廠user瞭解資料科學發揮空間並而提出應用需求。持續學習，並透過資料科學趨勢的書籍、文章或相關課程更新知識與持續進步。
